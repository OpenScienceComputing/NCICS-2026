...
declare class ZarrLayer {
    ...
    constructor({ id, source, variable, selector, colormap, clim, opacity, minzoom, maxzoom, zarrVersion, spatialDimensions, bounds, crs, latIsAscending, fillValue, customFrag, uniforms, renderingMode, onLoadingStateChange, throttleMs, proj4, transformRequest, store, renderPoles, }: ZarrLayerOptions);
...
export { type ColormapArray, type LoadingState, type LoadingStateCallback, type QueryDataValues, type QueryGeometry, type QueryResult, type RequestParameters, type Selector, type SpatialDimensions, type TransformRequest, ZarrLayer, type ZarrLayerOptions };
